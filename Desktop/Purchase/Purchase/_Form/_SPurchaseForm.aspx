...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <asp:Panel ID="Panel_SMCNumber" runat="server" style="margin-bottom:10px; border-bottom-style: dotted; border-bottom-width: 3px; border-bottom-color: #CCCCCC;">
                        ...
                        <tr>
                            <td align="left">
                                ...
                                <tr>
                                    ...
                                    <td width="150px">
                                        <asp:Label ID="Label96" runat="server" Font-Bold="true" 
                                        style="font-size: medium" Text="ทะเบียนรถ :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="Txt_CarPlate" runat="server" CssClass="textbox" Font-Bold="true" onfocus="formInUse = true;" onblur="formInUse = false;"
                                        ForeColor="Blue" Width="150px"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-left:50px; " width="130px">                                       
                                        <asp:Label ID="Label98" runat="server" Font-Bold="true" 
                                            style="font-size: medium" Text="หมายเลขตัวถัง :"></asp:Label>
                                    </td>
                                    <td width="270px">
                                        <asp:TextBox ID="Txt_TruckNumber" runat="server" CssClass="textbox" Font-Bold="true" onfocus="formInUse = true;" onblur="formInUse = false;"
                                        ForeColor="Blue" Width="200px"></asp:TextBox>
                                    </td>
                                    <td width="150px">
                                        <asp:Label ID="Label99" runat="server" Font-Bold="true" 
                                        style="font-size: medium" Text="หมายเลขโทรศัพท์ :"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="Txt_Tel_Mobile" runat="server" CssClass="textbox" Font-Bold="true" onfocus="formInUse = true;" onblur="formInUse = false;"
                                        ForeColor="Blue" Width="150px"></asp:TextBox>
                                    </td>
                                </tr>
                                </table>
                    ...
                    <asp:GridView ID="gv_PO" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="ทะเบียนรถ">
                                <ItemTemplate>
                                    <asp:Label ID="Lb_CarPlate" runat="server" Text='<%# Eval("_Purchase.CarPlate") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterStyle CssClass="style3" HorizontalAlign="Center" />
                                <HeaderStyle CssClass="style4" HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField HeaderText="สถานะ">
                                <ItemTemplate>
                                    <asp:ImageButton ID="Img_Status" runat="server" ImageUrl="~/Image/search.png" 
                                         Width="30px" OnClick="Img_ViewStatus_Click"/>
                                </ItemTemplate>
                                <HeaderStyle CssClass="style4" />
                                <ItemStyle CssClass="style3" HorizontalAlign="Center" Width="50px"/>
                ...
                <%--<asp:Panel ID="Panel_ViewStatus" runat="server" Visible="false">
                    <h2 style="text-align : center; padding-top:30px;">รายละเอียดความคืบหน้าจดทะเบียน</h2>
                    <table>
                        <tr>
                            <td>
        ...
        <tr>
            ...
            <td style="padding-left:5px; padding-top:10px;">
                <asp:LinkButton ID="LinkButton_Finance" runat="server" Text="ไฟแนนซ์/รายการชำระเงิน" 
                    ForeColor="White" style="padding-left:5px; padding-right:5px;" 
                    Font-Bold="true" Font-Size="Large" Font-Underline="false" Height="30px" 
                    onclick="LinkButton_Finance_Click">
                   </asp:LinkButton>
            </td>

            <asp:Panel ID="Panel_BtnInvoice" runat="server">
                        <td style="padding-left:5px; padding-top:10px;">
                        <asp:LinkButton ID="LinkButton_Invoice" runat="server" Text="ความคืบหน้าจดทะเบียน" 
                            ForeColor="White" style="padding-left:5px; padding-right:5px;" 
                            Font-Bold="true" Font-Size="Large" Font-Underline="false" Height="30px"
                            onClick="LinkButton_Invoice_Click">
                        </asp:LinkButton>
                    </td>
            </asp:Panel>
                            ...
                            <table>
                                  ...
                                  <tr>
                                            ...
                                            <td style="padding-left:50px; width:200px;">
                                                <asp:Label ID="Label101" runat="server" style="font-size: medium" 
                                                    Text="หมายเลขทะเบียน :"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="Txt_ECarPlate" runat="server" CssClass="textbox"  onfocus="formInUse = true;" onblur="formInUse = false;"
                                            ...
                                            <td style="padding-left:50px; ">
                                                <asp:Label ID="Label103" runat="server" style="font-size: medium" Text="ภาษีรถ :"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="Txt_CarTax" runat="server" CssClass="textbox"  onfocus="formInUse = true;" onblur="formInUse = false;"
                                                     ForeColor="Blue" Width="250px"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td style="padding-left:50px; width:200px;">
                                                <asp:Label ID="Label105" runat="server" style="font-size: medium" 
                                                    Text="วันที่จดทะเบียน :"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="Txt_RegisDate" runat="server" AutoPostBack="True" 
                                                    CssClass="textbox" Enabled="false" ForeColor="Blue" onblur="formInUse = false;" 
                                                    onfocus="formInUse = true;" ontextchanged="Txt_RegisDate_TextChanged" 
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59" Width="150px"></asp:TextBox>
                                                <asp:CalendarExtender ID="Txt_RegisDate_CalendarExtender" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_RegisDate" 
                                                    TargetControlID="Txt_RegisDate">
                                                </asp:CalendarExtender>
                                            ...
                                            <td style="padding-left:50px; ">
                                                <asp:Label ID="Label107" runat="server" style="font-size: medium" 
                                                    Text="ประเภทรถ :" ></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="DD_ECarType" runat="server" CssClass="textbox" 
                                            ...
                                            <tr>
                                              <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label64" runat="server" Text="ใบกำกับ : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_InvoiceDate" runat="server" CssClass="textbox" width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_InvoiceDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_InvoiceDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="invoice_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_InvoiceDate" 
                                                    TargetControlID="Txt_InvoiceDate">
                                                </asp:CalendarExtender>
                                              </td>
                                              <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label65" runat="server" Text="รับใบกำกับ : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_GetInvoiceDate" runat="server" CssClass="textbox" Width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_GetInvoiceDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_GetInvoiceDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="getinvoice_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_GetInvoiceDate" 
                                                    TargetControlID="Txt_GetInvoiceDate">
                                                </asp:CalendarExtender>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label66" runat="server" Text="รับชุดจด : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_NoteSetDate" runat="server" CssClass="textbox" Width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_NoteSetDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_NoteSetDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="noteset_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_NoteSetDate" 
                                                    TargetControlID="Txt_NoteSetDate">
                                                </asp:CalendarExtender>
                                              </td>
                                              <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label67" runat="server" Text="ส่งชุดจด : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_SendNoteSetDate" runat="server" CssClass="textbox" Width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_SendNoteSetDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_SendNoteSetDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="sendnoteset_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_SendNoteSetDate" 
                                                    TargetControlID="Txt_SendNoteSetDate">
                                                </asp:CalendarExtender>
                                              </td>
                                            </tr>
                                            <tr>
                                              <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label78" runat="server" Text="ส่งขนส่ง : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_SendTranSportDate" runat="server" CssClass="textbox" Width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_SendTranSportDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_SendTranSportDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="sendtransport_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_SendTranSportDate" 
                                                    TargetControlID="Txt_SendTranSportDate">
                                                </asp:CalendarExtender>
                                              </td>
                                              <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label79" runat="server" Text="รับคู่มือ : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_GetGuideDate" runat="server" CssClass="textbox" Width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_GetGuideDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_GetGuideDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="getguide_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_GetGuideDate" 
                                                    TargetControlID="Txt_GetGuideDate">
                                                </asp:CalendarExtender>
                                              </td>
                                            </tr>
                                            <tr>
                                            <td style="padding-left:50px; width:100px;">
                                                  <asp:Label ID="Label80" runat="server" Text="รับป้าย : " style="font-size: medium"></asp:Label>
                                              </td>
                                              <td style="width:200px;">
                                                <asp:TextBox ID="Txt_GetBadgeDate" runat="server" CssClass="textbox" Width="150px" Enabled="false" ForeColor="Blue"
                                                    AutoPostBack="True" ontextchanged="Txt_GetBadgeDate_TextChanged" onfocus="formInUse = true;" onblur="formInUse = false;"
                                                    ToolTip="*รูปแบบการกรอก 01/01/2559 หรือ 01 ม.ค. 59"></asp:TextBox>
                                                <asp:ImageButton ID="Img_GetBadgeDate" runat="server" ImageAlign="Bottom" 
                                                    ImageUrl="~/Image/Calendar.png" width="20px" Enabled="false"/>
                                                <asp:CalendarExtender ID="getbadge_calen" runat="server" 
                                                    Format="dd MMM yy" PopupButtonID="Img_GetBadgeDate" 
                                                    TargetControlID="Txt_GetBadgeDate">
                                                </asp:CalendarExtender>
                                              </td>
                                            </tr>
                                            <table cellpadding="0" cellspacing="3">
                                            <tr>
                                                <td style="padding-left:50px; " width="140px" valign="top">
                                                    <asp:Label ID="Label89" runat="server" style="font-size: medium" Text="หมายเหตุเพิ่มเติม :" ></asp:Label>
                                                <td>
                                                    <asp:TextBox ID="remarkInvoice_TextBox" runat="server" CssClass="textbox" 
                                                        Height="50px" onfocus="formInUse = true;" onblur="formInUse = false;" Enabled="false" ForeColor="Blue"
                                                        TextMode="MultiLine" Width="700px"></asp:TextBox>
                                                </td>
...
<%--                                                        <asp:Panel ID="Panel_AddInvoice" runat="server">    
                                                            <asp:ImageButton ID="Img_AddInvoice" runat="server" Height="25px" 
                                                                ImageUrl="~/Image/add.png" onclick="Img_EditInvoice_Click" />
                                                        </asp:Panel>--%>
                                                        <asp:Panel ID="Panel_EditInvoice" runat="server" >    
                                                            <asp:ImageButton ID="Img_EditInvoice" runat="server" Height="25px" 
                                                                ImageUrl="~/Image/edit.png" onclick="Img_EditInvoice_Click" />
                                                        </asp:Panel>
                                                        <asp:Panel ID="Panel_SaveInvoice" runat="server" Visible="false">
                                                        <asp:ImageButton ID="Img_SaveInvoice" runat="server" Height="30px" 
                                                                ImageUrl="~/Image/save.png" onclick="Img_SaveInvoice_Click" />   
                                                        <asp:ConfirmButtonExtender ID="ConfirmButtonExtender_SaveInvoice" 
                                                            runat="server" DisplayModalPopupID="mdpopup_SaveInvoice" Enabled="True" 
                                                            TargetControlID="Img_SaveInvoice">
                                                        </asp:ConfirmButtonExtender>
                                                        <asp:ModalPopupExtender ID="mdpopup_SaveInvoice" runat="server" 
                                                            BackgroundCssClass="modalBackground" CancelControlID="btnNo_SaveInvoice" 
                                                            OkControlID="btnYes_SaveInvoice" PopupControlID="pnlPopup_SaveInvoice" 
                                                            TargetControlID="Img_SaveInvoice">
                                                        </asp:ModalPopupExtender>
                                                        <asp:Panel ID="pnlPopup_SaveInvoice" runat="server" style="display:none">
                                                            <div class="confirm">
                                                                <h1>
                                                                    Confirm your action</h1>
                                                                <p>
                                                                    Are you sure <strong>Confirm</strong>?</p>
                                                                <button ID="btnYes_SaveInvoice" runat="server">
                                                                    Confirm
                                                                </button>
                                                                <button ID="btnNo_SaveInvoice" runat="server">
                                                                    Cancel
                                                                </button>
                                                            </div>
                                                        </asp:Panel>         
                                                        &nbsp;<asp:ImageButton ID="Img_CancelInvoice" runat="server" Height="30px" 
                                                                    ImageUrl="~/Image/cancel.png" onclick="Img_CancelInvoice_Click" />
                                                        </asp:Panel>
                                                    </center>
                                                </td>
                                            </tr>
...
<%--End Popup Address --%>
            ...
            <asp:Panel ID="Panel3" runat="server" Width="800px" style="display:none">
                <div align="center" class="modalPopupDetail" style="padding-bottom:10px; ">                   
                    <table cellpadding="0" cellspacing="0" width="100%" style="padding-top:5px; padding-left:5px; padding-right:5px;  ">
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0" width="100%" style="height:40px; background:#6189df; ">
                                    <tr>
                                        <td style="width:30px; padding-left:10px; padding-right:10px;">
                                            <asp:Image ID="Image22" runat="server" ImageUrl="~/Image/LOGO ISUZU1.png" Width="20px" />
                                        </td>
                                        <td align="left" >
                                            <asp:Label ID="Label84" runat="server" Font-Bold="True" Font-Size="Medium" 
                                                ForeColor="White" Text="ความคืบหน้าจดทะเบียน"></asp:Label>
                                            </td>
                                            <td style="width:30px;">
                                ...
                                <div align="left" style="width:100%; padding-top:10px; padding-bottom:10px; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #CCCCCC;">
                                    <div style="padding-left:50px;">
                                        <asp:Label ID="Label85" runat="server" Text="" ForeColor="Red" Font-Size="Small"></asp:Label>
                                    </div>
                                </div>
                            </td>
                            <tr>
                                <table>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label81" runat="server" Text="วันที่ออกรถ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="outcardate_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="label82" runat="server" Text="ที่ปรึกษาการขาย :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="sales_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="label83" runat="server" Text="เลขบัตรประชาชน :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="usernumber_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label87" runat="server" Text="ชื่อ - นามสกุล :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="name_Txt" runat="server" Text="Label"></asp:Label>
                                            <asp:Label ID="lastname_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label90" runat="server" Text="เบอร์มือถือ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="tel_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label92" runat="server" Text="Line ID :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="linrid_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label95" runat="server" Text="อาชีพ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;" colspan="3">
                                            <asp:Label ID="jobs_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
<%--                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label94" runat="server" Text="ที่อยู่ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="address_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>--%>
                                    <tr>
                                        <td style="width:500px; padding-left:50px;" colspan="4">
                                            <hr style="width:400px;"/>
                                        </td> 
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label100" runat="server" Text="สั่งซื้อรถ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="carname_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label102" runat="server" Text="ประเภทสั่งซื้อ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="buytype_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label104" runat="server" Text="หมายเลขเครื่อง :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="mcnumber_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label106" runat="server" Text="หมายเลขตัวถัง :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="trucknumber_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label108" runat="server" Text="รุ่น :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="mcode_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label110" runat="server" Text="แบบ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="mname_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label112" runat="server" Text="สี :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="carcolor_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label114" runat="server" Text="ราคา :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="carprice_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label116" runat="server" Text="หมายเลขทะเบียน :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="carplate_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label118" runat="server" Text="วันที่จดทะเบียน :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="regisdate_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label94" runat="server" Text= "ภาษี :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="cartax_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label97" runat="server" Text="ประเภทรถ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="cartype_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label120" runat="server" Text="มัดจำป้าย วันที่ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="redplateDate_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label122" runat="server" Text="มัดจำป้าย เลขที่ใบเสร็จ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="redplateNo_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label88" runat="server" Text="มัดจำป้าย จำนวนเงิน :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="redplatePrice_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label91" runat="server" Text="เลขป้ายแดง :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="redplateNum_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label86" runat="server" Text="หมายเหตุ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:300px;" colspan="3">
                                            <asp:Label ID="remark_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:500px; padding-left:50px;" colspan="4">
                                    ...
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label124" runat="server" Text="ใบกำกับ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="invoice_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label126" runat="server" Text="รับใบกำกับ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="getinvoice_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label128" runat="server" Text="ส่งขนส่ง :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="transport_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label130" runat="server" Text="รับคู่มือ :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="guide_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label132" runat="server" Text="รับชุดจด :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="noteset_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label134" runat="server" Text="ส่งชุดจด :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="sendnoteset_Txt" runat="server" Text="Label"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label136" runat="server" Text="รับป้าย :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:200px;">
                                            <asp:Label ID="badge_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                        
                                    </tr>
                                    <tr>
                                        <td style="width:200px; padding-left:50px;">
                                            <asp:Label ID="Label93" runat="server" Text="หมายเหตุการจดทะเบียน :" Font-Bold=true></asp:Label>
                                        </td>
                                        <td style="width:300px;" colspan="3">
                                            <asp:Label ID="remarkinvoice_Txt" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                        ...
                        <%--<tr>
                            <td>
                            <div Align="center" style="padding-top:10px;">
                                 <asp:Button ID="editinvoice_btn" runat="server" CssClass="css_button" Text="แก้ไข" Width="100px"
                                    onclick="editinvoice_btn_Click" />
                                </div>
                            </td>
                        </tr>--%>
                        </table>
            ...
            <%--end modal invoice--%>
            <%--<asp:ModalPopupExtender ID="ErrorPrintInvoice" runat="server" PopupControlID="errorprint" TargetControlID="Img_Print" BackgroundCssClass="modalBackground" >
                </asp:ModalPopupExtender>--%>
                   <%--<asp:Panel ID="errorprint" runat="server"  style="display:none">
                     <div class="confirm">
                       <h1>ไม่สามารถสร้างใบสั่งซื้อ</h1>
                       <p>เนื่องจากเกิดข้อผิดพลาด<strong></strong>!!</p>
                       <button id="Button4" runat="server">OK</button>
                     </div>
                   </asp:Panel> --%>
        </ContentTemplate>
        </asp:UpdatePanel>
